...
const ColorBox = props => (
    <div className="color-box col-xl-3 col-lg-3 col-md-3 col-sm-6 col-xs-12" style={{backgroundColor: props.background}} id={props.boxID}>
        ...
        <Link to={`/layout1/${props.boxID}`}><button className="color-box-btn login"> Edit</button></Link> <button onClick={props.handleDelete} className="color-box-btn login">Delete</button> <button onClick={props.handleModal} className="color-box-btn login">CSS</button>
    </div>
);
